...
export default function DetailsOfSponsorshipContainer() {
	return (
		<div className="border-mainWhite flexCol gap-6 rounded-md border lg:p-7 2xl:p-9">
			<PageTitle title="후원 내역" />
			<div className="border-mainWhite flexCol gap-2 rounded-md border lg:p-5 2xl:p-7">
